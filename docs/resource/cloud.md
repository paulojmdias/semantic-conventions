...
| `ibm_cloud.classic` | IBM Cloud Classic | ![Development](https://img.shields.io/badge/-development-blue) |
| `ibm_cloud.vpc` | IBM Cloud Virtual Private Cloud (VPC) | ![Development](https://img.shields.io/badge/-development-blue) |
